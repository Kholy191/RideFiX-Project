        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_carOwners_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_chatSessions_carOwners_CarOwnerId",
                        column: x => x.CarOwnerId,
                        principalTable: "carOwners",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_chatSessions_technicians_TechnicianId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_reviews_carOwners_CarOwnerId",
                        column: x => x.CarOwnerId,
                        principalTable: "carOwners",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TechnicianCategory", x => new { x.TechnicianId, x.TCategoryId });
                    table.ForeignKey(
                        name: "FK_TechnicianCategory_categories_TCategoryId",
                        column: x => x.TCategoryId,
                        principalTable: "categories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TechnicianCategory_technicians_TechnicianId",
                        column: x => x.TechnicianId,
                        principalTable: "technicians",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_carOwners_ApplicationUserId",
                table: "carOwners",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_chatSessions_CarOwnerId",
                table: "chatSessions",
                column: "CarOwnerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TechnicianCategory_TCategoryId",
